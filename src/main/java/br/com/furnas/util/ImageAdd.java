 ...
 * @author Jason Harrop
 */
public class ImageAdd implements FileUploadUtil {
	...
	public void findAndReplace() throws Exception {
		...
		// The image to add
		File file = new File(REPOSITORIO_TEMP + "imagem.jpg");
...
//		
		...
		// Now save it 
		wordMLPackage.save(new java.io.File(REPOSITORIO_TEMP + "resultadoImagem2.docx"));
